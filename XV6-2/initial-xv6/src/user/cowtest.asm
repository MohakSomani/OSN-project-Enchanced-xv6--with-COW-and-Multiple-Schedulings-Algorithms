...
simpletest()
{
  ...
  12:	c7250513          	add	a0,a0,-910 # c80 <malloc+0xee>
  ...
  80:	c5450513          	add	a0,a0,-940 # cd0 <malloc+0x13e>
  ...
  a6:	bee50513          	add	a0,a0,-1042 # c90 <malloc+0xfe>
  ...
  c0:	bec50513          	add	a0,a0,-1044 # ca8 <malloc+0x116>
  ...
  ea:	bd250513          	add	a0,a0,-1070 # cb8 <malloc+0x126>
...
threetest()
{
 ...
 114:	bc850513          	add	a0,a0,-1080 # cd8 <malloc+0x146>
 ...
 1a0:	b3450513          	add	a0,a0,-1228 # cd0 <malloc+0x13e>
 ...
 1c4:	ad050513          	add	a0,a0,-1328 # c90 <malloc+0xfe>
 ...
 1de:	b0650513          	add	a0,a0,-1274 # ce0 <malloc+0x14e>
 ...
 244:	ab050513          	add	a0,a0,-1360 # cf0 <malloc+0x15e>
 ...
 27e:	a8650513          	add	a0,a0,-1402 # d00 <malloc+0x16e>
 ...
 298:	a6c50513          	add	a0,a0,-1428 # d00 <malloc+0x16e>
 ...
 2b6:	a0650513          	add	a0,a0,-1530 # cb8 <malloc+0x126>
...
filetest()
{
 ...
 2dc:	a3850513          	add	a0,a0,-1480 # d10 <malloc+0x17e>
 ...
 376:	95e50513          	add	a0,a0,-1698 # cd0 <malloc+0x13e>
 ...
 392:	98a50513          	add	a0,a0,-1654 # d18 <malloc+0x186>
 ...
 3ac:	93850513          	add	a0,a0,-1736 # ce0 <malloc+0x14e>
 ...
 40a:	93a50513          	add	a0,a0,-1734 # d40 <malloc+0x1ae>
 ...
 424:	90850513          	add	a0,a0,-1784 # d28 <malloc+0x196>
 ...
 448:	91c50513          	add	a0,a0,-1764 # d60 <malloc+0x1ce>
 ...
 46c:	91050513          	add	a0,a0,-1776 # d78 <malloc+0x1e6>
...
main(int argc, char *argv[])
{
 ...
 4be:	8de50513          	add	a0,a0,-1826 # d98 <malloc+0x206>
 4c2:	00000097          	auipc	ra,0x0
 4c6:	618080e7          	jalr	1560(ra) # ada <printf>
...
atoi(const char *s)
{
 ...
 66a:	fd06879b          	addw	a5,a3,-48 # fd0 <digits+0x1c0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 85a:	5ba50513          	add	a0,a0,1466 # e10 <digits>
 85e:	883a                	mv	a6,a4
 860:	2705                	addw	a4,a4,1
 862:	02c5f7bb          	remuw	a5,a1,a2
 866:	1782                	sll	a5,a5,0x20
 868:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 8fc:	18090c63          	beqz	s2,a94 <vprintf+0x1b4>
 900:	8aaa                	mv	s5,a0
 902:	8bb2                	mv	s7,a2
 904:	00158493          	add	s1,a1,1
  state = 0;
 908:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
 ...
 90e:	4b55                	li	s6,21
 910:	a839                	j	92e <vprintf+0x4e>
        putc(fd, c);
 912:	85ca                	mv	a1,s2
 914:	8556                	mv	a0,s5
 916:	00000097          	auipc	ra,0x0
 91a:	efc080e7          	jalr	-260(ra) # 812 <putc>
 91e:	a019                	j	924 <vprintf+0x44>
    } else if(state == '%'){
 920:	01498d63          	beq	s3,s4,93a <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
 924:	0485                	add	s1,s1,1
 926:	fff4c903          	lbu	s2,-1(s1)
 92a:	16090563          	beqz	s2,a94 <vprintf+0x1b4>
    if(state == 0){
 92e:	fe0999e3          	bnez	s3,920 <vprintf+0x40>
      if(c == '%'){
 932:	ff4910e3          	bne	s2,s4,912 <vprintf+0x32>
        state = '%';
 936:	89d2                	mv	s3,s4
 938:	b7f5                	j	924 <vprintf+0x44>
      if(c == 'd'){
 93a:	13490263          	beq	s2,s4,a5e <vprintf+0x17e>
 93e:	f9d9079b          	addw	a5,s2,-99
 942:	0ff7f793          	zext.b	a5,a5
 946:	12fb6563          	bltu	s6,a5,a70 <vprintf+0x190>
 94a:	f9d9079b          	addw	a5,s2,-99
 94e:	0ff7f713          	zext.b	a4,a5
 952:	10eb6f63          	bltu	s6,a4,a70 <vprintf+0x190>
 956:	00271793          	sll	a5,a4,0x2
 95a:	00000717          	auipc	a4,0x0
 95e:	45e70713          	add	a4,a4,1118 # db8 <malloc+0x226>
 ...
 97c:	ebc080e7          	jalr	-324(ra) # 834 <printint>
 980:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
 982:	4981                	li	s3,0
 984:	b745                	j	924 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
 986:	008b8913          	add	s2,s7,8
 98a:	4681                	li	a3,0
 98c:	4629                	li	a2,10
 98e:	000ba583          	lw	a1,0(s7)
 992:	8556                	mv	a0,s5
 994:	00000097          	auipc	ra,0x0
 998:	ea0080e7          	jalr	-352(ra) # 834 <printint>
 99c:	8bca                	mv	s7,s2
      state = 0;
 99e:	4981                	li	s3,0
 9a0:	b751                	j	924 <vprintf+0x44>
 ...
 9b4:	e84080e7          	jalr	-380(ra) # 834 <printint>
 9b8:	8bca                	mv	s7,s2
      state = 0;
 9ba:	4981                	li	s3,0
 9bc:	b7a5                	j	924 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
 9be:	008b8c13          	add	s8,s7,8
 9c2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
 9c6:	03000593          	li	a1,48
 9ca:	8556                	mv	a0,s5
 9cc:	00000097          	auipc	ra,0x0
 9d0:	e46080e7          	jalr	-442(ra) # 812 <putc>
  putc(fd, 'x');
 9d4:	07800593          	li	a1,120
 9d8:	8556                	mv	a0,s5
 9da:	00000097          	auipc	ra,0x0
 9de:	e38080e7          	jalr	-456(ra) # 812 <putc>
 9e2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 9e4:	00000b97          	auipc	s7,0x0
 9e8:	42cb8b93          	add	s7,s7,1068 # e10 <digits>
 9ec:	03c9d793          	srl	a5,s3,0x3c
 9f0:	97de                	add	a5,a5,s7
 9f2:	0007c583          	lbu	a1,0(a5)
 9f6:	8556                	mv	a0,s5
 9f8:	00000097          	auipc	ra,0x0
 9fc:	e1a080e7          	jalr	-486(ra) # 812 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 a00:	0992                	sll	s3,s3,0x4
 a02:	397d                	addw	s2,s2,-1
 a04:	fe0914e3          	bnez	s2,9ec <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
 a08:	8be2                	mv	s7,s8
      state = 0;
 a0a:	4981                	li	s3,0
 a0c:	bf21                	j	924 <vprintf+0x44>
        s = va_arg(ap, char*);
 a0e:	008b8993          	add	s3,s7,8
 a12:	000bb903          	ld	s2,0(s7)
        if(s == 0)
 a16:	02090163          	beqz	s2,a38 <vprintf+0x158>
        while(*s != 0){
 a1a:	00094583          	lbu	a1,0(s2)
 a1e:	c9a5                	beqz	a1,a8e <vprintf+0x1ae>
          putc(fd, *s);
 a20:	8556                	mv	a0,s5
 a22:	00000097          	auipc	ra,0x0
 a26:	df0080e7          	jalr	-528(ra) # 812 <putc>
          s++;
 a2a:	0905                	add	s2,s2,1
        while(*s != 0){
 a2c:	00094583          	lbu	a1,0(s2)
 a30:	f9e5                	bnez	a1,a20 <vprintf+0x140>
        s = va_arg(ap, char*);
 a32:	8bce                	mv	s7,s3
      state = 0;
 a34:	4981                	li	s3,0
 a36:	b5fd                	j	924 <vprintf+0x44>
          s = "(null)";
 a38:	00000917          	auipc	s2,0x0
 a3c:	37890913          	add	s2,s2,888 # db0 <malloc+0x21e>
        while(*s != 0){
 a40:	02800593          	li	a1,40
 a44:	bff1                	j	a20 <vprintf+0x140>
 ...
 a86:	d90080e7          	jalr	-624(ra) # 812 <putc>
      state = 0;
 a8a:	4981                	li	s3,0
 a8c:	bd61                	j	924 <vprintf+0x44>
        s = va_arg(ap, char*);
 a8e:	8bce                	mv	s7,s3
      state = 0;
 a90:	4981                	li	s3,0
 a92:	bd49                	j	924 <vprintf+0x44>
    }
  }
}
 a94:	60a6                	ld	ra,72(sp)
 a96:	6406                	ld	s0,64(sp)
 a98:	74e2                	ld	s1,56(sp)
 a9a:	7942                	ld	s2,48(sp)
 a9c:	79a2                	ld	s3,40(sp)
 a9e:	7a02                	ld	s4,32(sp)
 aa0:	6ae2                	ld	s5,24(sp)
 aa2:	6b42                	ld	s6,16(sp)
 aa4:	6ba2                	ld	s7,8(sp)
 aa6:	6c02                	ld	s8,0(sp)
 aa8:	6161                	add	sp,sp,80
 aaa:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 ace:	e16080e7          	jalr	-490(ra) # 8e0 <vprintf>
}
 ad2:	60e2                	ld	ra,24(sp)
 ad4:	6442                	ld	s0,16(sp)
 ad6:	6161                	add	sp,sp,80
 ad8:	8082                	ret
...
{
 ada:	711d                	add	sp,sp,-96
 adc:	ec06                	sd	ra,24(sp)
 ade:	e822                	sd	s0,16(sp)
 ae0:	1000                	add	s0,sp,32
 ae2:	e40c                	sd	a1,8(s0)
...
free(void *ap)
{
 b10:	1141                	add	sp,sp,-16
 b12:	e422                	sd	s0,8(sp)
 b14:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 b16:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 b1a:	00000797          	auipc	a5,0x0
 b1e:	4ee7b783          	ld	a5,1262(a5) # 1008 <freep>
 b22:	a02d                	j	b4c <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
 b24:	4618                	lw	a4,8(a2)
 b26:	9f2d                	addw	a4,a4,a1
 b28:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
 b2c:	6398                	ld	a4,0(a5)
 b2e:	6310                	ld	a2,0(a4)
 b30:	a83d                	j	b6e <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
 b32:	ff852703          	lw	a4,-8(a0)
 b36:	9f31                	addw	a4,a4,a2
 b38:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
 b3a:	ff053683          	ld	a3,-16(a0)
 b3e:	a091                	j	b82 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 b40:	6398                	ld	a4,0(a5)
 b42:	00e7e463          	bltu	a5,a4,b4a <free+0x3a>
 b46:	00e6ea63          	bltu	a3,a4,b5a <free+0x4a>
{
 b4a:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 b4c:	fed7fae3          	bgeu	a5,a3,b40 <free+0x30>
 b50:	6398                	ld	a4,0(a5)
 b52:	00e6e463          	bltu	a3,a4,b5a <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 b56:	fee7eae3          	bltu	a5,a4,b4a <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
 b5a:	ff852583          	lw	a1,-8(a0)
 b5e:	6390                	ld	a2,0(a5)
 b60:	02059813          	sll	a6,a1,0x20
 b64:	01c85713          	srl	a4,a6,0x1c
 b68:	9736                	add	a4,a4,a3
 b6a:	fae60de3          	beq	a2,a4,b24 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
 b6e:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 b72:	4790                	lw	a2,8(a5)
 b74:	02061593          	sll	a1,a2,0x20
 b78:	01c5d713          	srl	a4,a1,0x1c
 b7c:	973e                	add	a4,a4,a5
 b7e:	fae68ae3          	beq	a3,a4,b32 <free+0x22>
    p->s.ptr = bp->s.ptr;
 b82:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
...
malloc(uint nbytes)
{
 ...
 ba0:	e456                	sd	s5,8(sp)
 ba2:	e05a                	sd	s6,0(sp)
 ba4:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ba6:	02051493          	sll	s1,a0,0x20
 baa:	9081                	srl	s1,s1,0x20
 bac:	04bd                	add	s1,s1,15
 bae:	8091                	srl	s1,s1,0x4
 bb0:	0014899b          	addw	s3,s1,1
 bb4:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 bb6:	00000517          	auipc	a0,0x0
 bba:	45253503          	ld	a0,1106(a0) # 1008 <freep>
 bbe:	c515                	beqz	a0,bea <malloc+0x58>
 ...
 bc0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 bc2:	4798                	lw	a4,8(a5)
 bc4:	02977f63          	bgeu	a4,s1,c02 <malloc+0x70>
  if(nu < 4096)
 bc8:	8a4e                	mv	s4,s3
 bca:	0009871b          	sext.w	a4,s3
 bce:	6685                	lui	a3,0x1
 bd0:	00d77363          	bgeu	a4,a3,bd6 <malloc+0x44>
 bd4:	6a05                	lui	s4,0x1
 bd6:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
 bda:	004a1a1b          	sllw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
 bde:	00000917          	auipc	s2,0x0
 be2:	42a90913          	add	s2,s2,1066 # 1008 <freep>
  if(p == (char*)-1)
 be6:	5afd                	li	s5,-1
 be8:	a895                	j	c5c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 bea:	00004797          	auipc	a5,0x4
 bee:	42678793          	add	a5,a5,1062 # 5010 <base>
 bf2:	00000717          	auipc	a4,0x0
 bf6:	40f73b23          	sd	a5,1046(a4) # 1008 <freep>
 bfa:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 bfc:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 c00:	b7e1                	j	bc8 <malloc+0x36>
      if(p->s.size == nunits)
 c02:	02e48c63          	beq	s1,a4,c3a <malloc+0xa8>
        p->s.size -= nunits;
 c06:	4137073b          	subw	a4,a4,s3
 c0a:	c798                	sw	a4,8(a5)
        p += p->s.size;
 c0c:	02071693          	sll	a3,a4,0x20
 c10:	01c6d713          	srl	a4,a3,0x1c
 c14:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 c16:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 c1a:	00000717          	auipc	a4,0x0
 c1e:	3ea73723          	sd	a0,1006(a4) # 1008 <freep>
      return (void*)(p + 1);
 c22:	01078513          	add	a0,a5,16
 ...
 c3a:	6398                	ld	a4,0(a5)
 c3c:	e118                	sd	a4,0(a0)
 c3e:	bff1                	j	c1a <malloc+0x88>
  hp->s.size = nu;
 c40:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 c44:	0541                	add	a0,a0,16
 c46:	00000097          	auipc	ra,0x0
 c4a:	eca080e7          	jalr	-310(ra) # b10 <free>
  return freep;
 c4e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 c52:	d971                	beqz	a0,c26 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 c54:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 c56:	4798                	lw	a4,8(a5)
 c58:	fa9775e3          	bgeu	a4,s1,c02 <malloc+0x70>
    if(p == freep)
 c5c:	00093703          	ld	a4,0(s2)
 c60:	853e                	mv	a0,a5
 c62:	fef719e3          	bne	a4,a5,c54 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
 c66:	8552                	mv	a0,s4
 c68:	00000097          	auipc	ra,0x0
 c6c:	b7a080e7          	jalr	-1158(ra) # 7e2 <sbrk>
  if(p == (char*)-1)
 c70:	fd5518e3          	bne	a0,s5,c40 <malloc+0xae>
        return 0;
 c74:	4501                	li	a0,0
 c76:	bf45                	j	c26 <malloc+0x94>
