...
main(int argc, char *argv[])
{
  ...
  40:	7e458593          	add	a1,a1,2020 # 820 <malloc+0xec>
  44:	4509                	li	a0,2
  46:	00000097          	auipc	ra,0x0
  4a:	608080e7          	jalr	1544(ra) # 64e <fprintf>
    exit(1);
  4e:	4505                	li	a0,1
  ...
  5e:	7de58593          	add	a1,a1,2014 # 838 <malloc+0x104>
  62:	4509                	li	a0,2
  64:	00000097          	auipc	ra,0x0
  68:	5ea080e7          	jalr	1514(ra) # 64e <fprintf>
      break;
    }
  }
...
putc(int fd, char c)
{
 ...
 3ca:	f56080e7          	jalr	-170(ra) # 31c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	4c050513          	add	a0,a0,1216 # 8b8 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	36470713          	add	a4,a4,868 # 860 <malloc+0x12c>
 ...
 58a:	332b8b93          	add	s7,s7,818 # 8b8 <digits>
 ...
 5de:	27e90913          	add	s2,s2,638 # 858 <malloc+0x124>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 80e:	b7a080e7          	jalr	-1158(ra) # 384 <sbrk>
  if(p == (char*)-1)
