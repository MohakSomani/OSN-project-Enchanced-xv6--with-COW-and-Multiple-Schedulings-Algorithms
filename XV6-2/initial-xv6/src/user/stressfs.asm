...
main(int argc, char *argv[])
{
  ...
  1a:	8ca78793          	add	a5,a5,-1846 # 8e0 <malloc+0x116>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	88450513          	add	a0,a0,-1916 # 8b0 <malloc+0xe6>
  ...
  6c:	86050513          	add	a0,a0,-1952 # 8c8 <malloc+0xfe>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	82250513          	add	a0,a0,-2014 # 8d8 <malloc+0x10e>
...
putc(int fd, char c)
{
 44a:	1101                	add	sp,sp,-32
 44c:	ec06                	sd	ra,24(sp)
 44e:	e822                	sd	s0,16(sp)
 450:	1000                	add	s0,sp,32
 452:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 456:	4605                	li	a2,1
 458:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 492:	4c250513          	add	a0,a0,1218 # 950 <digits>
 496:	883a                	mv	a6,a4
 498:	2705                	addw	a4,a4,1
 49a:	02c5f7bb          	remuw	a5,a1,a2
 49e:	1782                	sll	a5,a5,0x20
 4a0:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 58e:	00271793          	sll	a5,a4,0x2
 592:	00000717          	auipc	a4,0x0
 596:	36670713          	add	a4,a4,870 # 8f8 <malloc+0x12e>
 ...
 620:	334b8b93          	add	s7,s7,820 # 950 <digits>
 ...
 638:	0992                	sll	s3,s3,0x4
 63a:	397d                	addw	s2,s2,-1
 ...
 674:	28090913          	add	s2,s2,640 # 8f0 <malloc+0x126>
        while(*s != 0){
...
{
 712:	711d                	add	sp,sp,-96
 714:	ec06                	sd	ra,24(sp)
 716:	e822                	sd	s0,16(sp)
 718:	1000                	add	s0,sp,32
 71a:	e40c                	sd	a1,8(s0)
...
free(void *ap)
{
 ...
 74a:	e422                	sd	s0,8(sp)
 74c:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 74e:	ff050693          	add	a3,a0,-16
 ...
 77e:	00e6ea63          	bltu	a3,a4,792 <free+0x4a>
{
 ...
 796:	6390                	ld	a2,0(a5)
 798:	02059813          	sll	a6,a1,0x20
 79c:	01c85713          	srl	a4,a6,0x1c
 ...
 7a6:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 7aa:	4790                	lw	a2,8(a5)
 7ac:	02061593          	sll	a1,a2,0x20
 7b0:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 81a:	7ea90913          	add	s2,s2,2026 # 1000 <freep>
  if(p == (char*)-1)
 81e:	5afd                	li	s5,-1
 820:	a895                	j	894 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 822:	00000797          	auipc	a5,0x0
 826:	7ee78793          	add	a5,a5,2030 # 1010 <base>
 ...
 842:	c798                	sw	a4,8(a5)
        p += p->s.size;
 844:	02071693          	sll	a3,a4,0x20
 848:	01c6d713          	srl	a4,a3,0x1c
 ...
 8a4:	b7a080e7          	jalr	-1158(ra) # 41a <sbrk>
  if(p == (char*)-1)
